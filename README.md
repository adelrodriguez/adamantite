...
`@shadcn/lint` as a devDependency too. With npm, list `typescript` in your own
`package.json` first, or the install fails with `ERESOLVE`. The plugin finds your components and theme
