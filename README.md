...
and OpenCode (`opencode`) — and lists only the ones found on `PATH`. It warns before
starting an agent on a working tree that is not known to be clean. OpenCode pre-fills
