// Vendored build of the shadcn oxlint plugin.
...
//#endregion
//#region packages/lint/src/grammar/categories.ts
...
function isArbitraryValue$1(token) {
...
const PALETTE_RE = new RegExp(`${COLOR_PREFIX.source}(?:${PALETTE$1.join("|")})-\\d{2,3}(?:${OPACITY_MODIFIER.source})?$`);
...
//#endregion
//#region packages/lint/src/grammar/lengths.ts
const REM = 16;
...
//#endregion
//#region packages/lint/src/project/warn.ts
...
//#endregion
//#region packages/lint/src/grammar/validators.ts
...
//#endregion
//#region packages/lint/src/grammar/classifier.ts
...
function bundled() {
	bundledConfig ??= getDefaultCnConfig();
...
//#endregion
//#region packages/lint/src/grammar/colors.ts
const NAMED$1 = {
	aliceblue: "#f0f8ff",
	antiquewhite: "#faebd7",
	aqua: "#00ffff",
...
//#endregion
//#region packages/lint/src/grammar/tailwind-theme.ts
const PALETTE = {
...
//#endregion
//#region packages/lint/src/project/resolve.ts
const EXTENSIONS = [
	".tsx",
	".ts",
	".jsx",
...
function resolveFile(spec, fromDir, rootDir, extensions = EXTENSIONS, options = {}) {
	return memoize(`resolve:${fromDir}|${rootDir}|${spec}|${extensions.join(",")}|${options.skipPaths ? 1 : 0}`, () => resolveFileUncached(spec, fromDir, rootDir, extensions, options));
}
//#endregion
//#region packages/lint/src/project/components-json.ts
...
//#endregion
//#region packages/lint/src/project/theme.ts
...
//#endregion
//#region packages/lint/src/project/namespaces.ts
const NAMESPACES = [
	{
		prefix: "text-shadow-",
...
//#endregion
//#region packages/lint/src/project/component-imports.ts
...
//#endregion
//#region packages/lint/src/project/modules.ts
...
//#endregion
//#region packages/lint/src/project/components.ts
const EMPTY = {
	dir: null,
...
//#endregion
//#region packages/lint/src/project/ast.ts
...
//#endregion
//#region packages/lint/src/project/parser.ts
...
function loadTypeScript() {
	...
	try {
		...
		warnOnce("parser:none", "Neither oxc-parser nor @typescript-eslint/parser is installed, so component files cannot be read: variants and wrappers are unknown until one is.");
...
//#endregion
//#region packages/lint/src/project/wrappers.ts
...
//#endregion
//#region packages/lint/src/rules/messages.ts
const LISTED = 12;
...
//#endregion
//#region packages/lint/src/rules/settings.ts
const SHARED = [
	"componentImports",
	"ignoreImports",
	"mergeFunctions",
...
//#endregion
//#region packages/lint/src/sites/collect.ts
...
//#endregion
//#region packages/lint/src/rules/contracts.ts
...
//#endregion
//#region packages/lint/src/rules/fixes.ts
...
//#endregion
//#region packages/lint/src/rules/policy-schema.ts
const entriesSchema = {
	type: "array",
	items: { type: "string" }
};
...
function arbitraryColor(inner) {
	return parseColor(inner.replace(/^color:/, "").replace(/_/g, " "));
}
...
//#endregion
//#region packages/lint/src/rules/no-arbitrary-values.ts
...
//#endregion
//#region packages/lint/src/rules/no-inline-styles.ts
...
//#endregion
//#region packages/lint/src/tailwind/client.ts
let bridge = null;
let restarts = 0;
...
//#endregion
//#region packages/lint/src/rules/no-raw-colors.ts
...
//#endregion
//#region packages/lint/src/project/variants.ts
const cache = /* @__PURE__ */ new Map();
...
//#endregion
//#region packages/lint/src/rules/no-restyle.ts
...
//#endregion
//#region packages/lint/src/rules/no-unknown-classes.ts
const MESSAGES$1 = {
...
//#endregion
//#region packages/lint/src/rules/require-static-classes.ts
